...
public class DefaultBandService implements BandService {
  ...
  /**
   * Gets all bands for given code by delegating to {@link BandDAO#findBandsByCode(String)} and then
   * assuring uniqueness of result.
   */
  @Override
  public BandModel getBandForCode(final String code)
    ...
    if (result.isEmpty()) {
      ...
      throw new AmbiguousIdentifierException(
          "Band code '" + code + "' is not unique, " + result.size() + " bands found!");
    }
    return result.get(0);
  }
