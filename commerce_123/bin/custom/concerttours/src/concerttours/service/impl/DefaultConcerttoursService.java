...
public class DefaultConcerttoursService implements ConcerttoursService {
  ...
  private final static String FIND_LOGO_QUERY =
      "SELECT {" + CatalogUnawareMediaModel.PK + "} FROM {"
          + CatalogUnawareMediaModel._TYPECODE + "} WHERE {" + CatalogUnawareMediaModel.CODE
          + "}=?code";
  ...
  private InputStream getImageStream() {
    return DefaultConcerttoursService.class.getResourceAsStream(
        "/concerttours/sap-hybris-platform.png");
  }
